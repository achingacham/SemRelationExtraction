...
if __name__ == '__main__':
    ...
    try:
        os.mkdir(ofolder+ifolder.rsplit('/',2)[1])
    except:
    ...
    plot_results(train_cost, "Epochs",outfolder+"TrainPlot.png")
    
    dev_cost = validate(OUTPUT_LABEL)
    plot_results(dev_cost, "Dev data",outfolder+"DevPlot.png")
    
    test_cost = test(OUTPUT_LABEL)
    plot_results(test_cost, "Test data",outfolder+"TestPlot.png")
