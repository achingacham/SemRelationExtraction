...
def train(labelCount, logfile):
    ...
    for epoch in range(epochs):
        ...
        dev_cost = validate(OUTPUT_LABEL, outfolder+'logfile_LR.log')
        
        epochCostDev.append(dev_cost)
        
    plot_results(epochCostDev, "Dev data",outfolder+"DevPlot_withWordVectors_LR.png") 
...
if __name__ == '__main__':
    ...
    outfolder = ofolder+ifolder.rsplit('/',2)[1]+'/Bless/RelationWordVectors/'
    ...
    plot_results(train_cost, "Epochs",outfolder+"TrainPlot_withWordVectors_LR.png")
    
    
    test_cost = test(OUTPUT_LABEL, outfolder+'logfile_LR.log')
    #plot_results(test_cost, "Test data",outfolder+"TestPlot_withWordVectors_LR.png")
