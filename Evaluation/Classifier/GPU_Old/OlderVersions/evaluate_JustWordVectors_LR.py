...
def train(labelCount, logfile):
    ...
    plot_results(epochCostDev, "Dev data",outfolder+"DevPlot_justWordVectors_LR.png") 
...
if __name__ == '__main__':
    ...
    plot_results(train_cost, "Epochs",outfolder+"TrainPlot_justWordVectors_LR.png")
    
    
    test_cost = test(OUTPUT_LABEL, outfolder+'logfile_LR.log')
   # plot_results(test_cost, "Test data",outfolder+"TestPlot_justWordVectors_LR.png")
