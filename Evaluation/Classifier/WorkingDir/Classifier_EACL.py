...
if __name__ == '__main__':
    ...
    results[0] = mTrain.train(batchSize, epochTrain, l2_factor[0], lr)
    ...
    results[1] = mTrain.train(batchSize, epochTrain, l2_factor[1], lr)
    ...
    results[2] = mTrain.train(batchSize, epochTrain, l2_factor[2], lr)
